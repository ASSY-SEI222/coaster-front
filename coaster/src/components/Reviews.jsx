...
function Reviews() {
  ...
  const sendToAPI = async (e) => {
      ...
      const something = await axios.get(`http://127.0.0.1:3001/api/allCoasters`)  

      e.preventDefault()  
      console.log(something.coasters)
 }
        ...
        <form id="feedback" action="">
          ...
          <div className="form-group">
            ...
            <div className="input-group">
              ...
              <input name="comment" type="text" className="form-control" placeholder="I love this ride!" onChange={(e) => setEmail(e.target.value)} />
